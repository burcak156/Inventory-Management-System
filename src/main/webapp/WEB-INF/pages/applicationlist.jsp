...
<tr>
	<td><c:out value="${app.applicationId}" /></td>
	<td><c:out value="${app.applicationName}"/></td>
	<td><c:out value="${app.applicationCode}"/></td>
	<td>
	<a href="${pageContext.request.contextPath}/application/edit/${app.applicationId}.html">Edit</a><br/>
	<a href="${pageContext.request.contextPath}/application/delete/${app.applicationId}.html">Delete</a><br/>
	</td>
</tr>
</c:forEach>
</tbody>
